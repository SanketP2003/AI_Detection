            ...
            <div className="relative z-10 grid gap-4 md:gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              {features.map((f, i) => (
                ...
                >
                  ...
                  <p className="text-white font-space text-lg">{f.title}</p>
                  <p className="text-sm text-mist/80 leading-relaxed">{f.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            {kpis.map((k, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="text-2xl md:text-3xl font-space font-semibold text-white">{k.number}</div>
                <div className="text-xs uppercase tracking-[0.3em] text-mist/70 mt-1">{k.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
