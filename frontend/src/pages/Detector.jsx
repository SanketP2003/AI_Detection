          ...
          <div className="section-shell grid-overlay">
            <div className="relative z-10 space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {[ 'Signal mapping', 'Pattern triage', 'Confidence board' ].map((title, idx) => (
                  <motion.div
                    key={title}
                  ...
                  >
                    ...
                    <p className="text-white font-space text-xl">{title}</p>
                    <p className="text-sm text-mist/80 leading-relaxed">
                      {[
                        'We isolate cadence, burstiness, and entropy to establish a baseline signature.',
                        'Anomaly hunters score suspect tokens and cross-check with known AI fingerprints.',
                        'We assemble a concise board with confidence, metrics, and callouts for review.'
                      ][idx]}
                    </p>
                  </motion.div>
                ))}
