...
import { Send, Bot, User, Loader, AlertCircle, History, Trash2, RefreshCw, Sparkles, Clock, X, Menu } from 'lucide-react';
...
const ChatInterface = () => {
  ...
  useEffect(() => {
    // On mount, check backend Mistral health so we can show a clear message if misconfigured
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setError('Failed to connect to the AI advisor. Please make sure you are logged in and the backend is running.');
